...
const CONFIGS: Record<number, Config> = {
  [kChain.zora]: {
    ...
    poolOld: {
      ...
      chainId: kChain.zora,
      currency0: { chainId: kChain.zora, address: '0x0000000000000000000000000000000000000000', name: 'ETH', symbol: 'ETH', decimals: 18, dp: 4, icon: 'ETH.svg' },
      currency1: { chainId: kChain.zora, address: '0xCccCCccc7021b32EBb4e8C08314bD62F7c653EC4', name: 'USDzC', symbol: 'USDzC', decimals: 6, dp: 4, icon: 'USDzC.svg' },
    ...
    poolLegacy: {
      ...
      liquidity: { chainId: kChain.zora, address: '0xE5bADF998f5c5828c139081f5510706f44B8E224', name: 'ETH-USDzC', symbol: 'ETH-USDzC', decimals: 18, dp: 4 },
    },
    tokens: [
      { chainId: kChain.zora, address: '0x28A46A961CDe54bCE2F428554fBE8AF040a67B47', name: 'ETH+', symbol: 'ETH+', decimals: 18, dp: 4, icon: 'ETH.svg', origin: '0x0000000000000000000000000000000000000000' },
      { chainId: kChain.zora, address: '0x054757a979f77FD5B0c85679bbA73A92B0e773F4', name: 'USDzC+', symbol: 'USDzC+', decimals: 6, dp: 4, icon: 'USDzC.svg', origin: '0xCccCCccc7021b32EBb4e8C08314bD62F7c653EC4' },
    ],
    fee: 60000000000000n,
  },
  [kChain.base]: {
    ...
    poolOld: {
      ...
      chainId: kChain.base,
      currency0: { chainId: kChain.base, address: '0x0000000000000000000000000000000000000000', name: 'ETH', symbol: 'ETH', decimals: 18, dp: 4, icon: 'ETH.svg' },
      currency1: { chainId: kChain.base, address: '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', name: 'USD Coin', symbol: 'USDC', decimals: 6, dp: 4, icon: 'USDC.svg' },
    ...
    poolLegacy: {
      ...
      liquidity: { chainId: kChain.base, address: '0x60d7D35232D178BaE9B082210B2A12C004127c70', name: 'ETH-USDC', symbol: 'ETH-USDC', decimals: 18, dp: 4 },
    },
    tokens: [
      { chainId: kChain.base, address: '0x7395160D0b882c5C8123Ed612fa355eE61259da5', name: 'ETH+', symbol: 'ETH+', decimals: 18, dp: 4, icon: 'ETH.svg', origin: '0x0000000000000000000000000000000000000000' },
      { chainId: kChain.base, address: '0x2cF1F206C55C75bbB621b961Bd0fA17AEbbcD32F', name: 'USDC+', symbol: 'USDC+', decimals: 6, dp: 4, icon: 'USDC.svg', origin: '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913' },
      { chainId: kChain.base, address: '0x14a760e4D05a04bFbd6e5cB9114626ACDb342ca8', name: 'DAI+', symbol: 'DAI+', decimals: 18, dp: 4, icon: 'DAI.svg', origin: '0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb' },
    ],
    fee: 60000000000000n,
  },
}
