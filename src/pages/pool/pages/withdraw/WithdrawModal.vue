  ...
  <ActionModal v-model="modelValue">
    <div class="flex-center flex-col gap-3">
      <div class="flex-center gap-1 overflow-hidden">
        ...
        <ZTokenBalance class="!font-normal text-basic/90" :token="data.pool.currency0" :balance="data.amount0Min" />
      </div>
      <i-ff-unpair class="size-6" />
      <div class="flex-center gap-1 overflow-hidden">
        <ZTokenIcon :token="data.pool.currency1" />
        <ZTokenBalance class="!font-normal text-basic/90" :token="data.pool.currency1" :balance="data.amount1Min" />
      </div>
    </div>
  </ActionModal>
</template>
