        ...
        <div v-if="data" class="flex flex-col gap-2">
          ...
          <div class="flex-y-center justify-between bg-card/40 px-4 py-3 h-12">
            ...
            <div class="flex gap-1">
              ...
              <n-text class="text-error">
                (${{ formatPrice(data.outputValue) }})
              </n-text>
            </div>
          </div>
        </div>
        <div class="flex-center gap-6">
          <ZGhostButton class="flex-1 w-full h-10" @click="onCancel">
            Cancel
          </ZGhostButton>
          <ZButton class="flex-1 w-full h-10" @click="onContinue">
            Continue
          </ZButton>
        </div>
      </div>
