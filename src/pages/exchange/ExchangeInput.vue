  ...
  <div class="flex flex-col gap-3">
    ...
    <div class="p-4 flex flex-col bg-card rounded-lg">
      <div class="mb-2 sm:px-2 flex-y-center gap-2">
        <n-input-number class="flex-1 exchange-amount-input" v-model:value="amount" :min="0" :max="maxAmount" placeholder="0.0" :readonly="!isSupported" :bordered="false" :show-button="false" :on-blur="onInputBlur" />
