<template>
  <div class="h-10 flex-y-center gap-2 py-1 px-2 sm:px-1 bg-container rounded-lg cursor-pointer">
...
import { account, nativeBalance, nativeCurrency } from '@/hooks/useWallet'
