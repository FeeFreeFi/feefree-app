      ...
      <div class="relative flex flex-col px-6 pb-6">
        ...
        <div class="flex-center min-h-32">
          ...
          <div v-else class="flex-center">
            <n-text class="text-error" depth="1">
              {{ modelValue.error }}
            </n-text>
          </div>
        </div>
        <div class="relative flex-col flex-center gap-3">
          ...
          <ZButton v-else-if="state === kState.success" class="w-32 h-9" size="small" @click="onClose">
            OK
          </ZButton>
          <ZButton v-else class="w-32 h-9" size="small" @click="onClose">
            Dismiss
          </ZButton>
        </div>
      </div>
